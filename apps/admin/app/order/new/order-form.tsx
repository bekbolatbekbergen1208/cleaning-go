...
export function OrderForm({ services, companies, preferredCompanyId, companyLocked, unavailableLockedCompany, bonusBalances }: {
  services: Service[];
  companies: Company[];
  preferredCompanyId: string | null;
  companyLocked: boolean;
  unavailableLockedCompany: boolean;
